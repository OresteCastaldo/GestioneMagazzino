...
public class JpaUtil {
    ...
    private JpaUtil() {
         ...
         *
         * Il nome "MagazzinoPU" deve coincidere con:
         *
         * <persistence-unit name="MagazzinoPU">
         */
        emf = Persistence.createEntityManagerFactory("MagazzinoPU");
    }

    /*
     * Punto di accesso globale all'unica istanza di JpaUtil in modo thread-safe.
     *
     * Se l'istanza non esiste ancora, viene creata.
     * Se è già stata creata, viene semplicemente restituita.
     *
     * Questo metodo completa l'applicazione del pattern Singleton (Thread-Safe).
     */
